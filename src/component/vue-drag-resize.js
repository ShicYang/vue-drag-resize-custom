...
export default {
    ...
    methods: {
        setSize(ev) {
            ...
            const deltaX = this.width - ev.w;
            const deltaY = this.height - ev.h;

            this.stickDown(
                stick,
                { pageX: this.right, pageY: this.bottom },
                true
            );
            // stickMove方法改造
            // this,stickMove({ x: deltaX, y:deltaY });
            this.bottom = this.dimensionsBeforeMove.bottom + deltaY;
            this.right = this.dimensionsBeforeMove.right + deltaX;
        ...
        setPosition(ev) {
            const deltaX = this.left - ev.x;
            const deltaY = this.top - ev.y;
        ...
        bodyMove(delta, ev) {
            ...
            if (this.snapToGrid) {
                ...
                let diffL = newLeft - Math.floor(newLeft / gridX) * gridY;
                let diffR =
